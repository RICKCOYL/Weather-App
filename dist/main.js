...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar UI = /*#__PURE__*/function () {\n  function UI() {\n    _classCallCheck(this, UI);\n\n    this.location = document.getElementById('w-location');\n    this.desc = document.getElementById('w-desc');\n    this.string = document.getElementById('w-string');\n    this.details = document.getElementById('w-details');\n    this.icon = document.getElementById('w-icon');\n    this.humidity = document.getElementById('w-humidity');\n    this.feelsLike = document.getElementById('w-feels-like');\n    this.dewpoint = document.getElementById('w-dewpoint');\n    this.wind = document.getElementById('w-wind');\n  }\n\n  _createClass(UI, [{\n    key: \"paint\",\n    value: function paint(weather) {\n      this.location.textContent = \"\".concat(weather.sys.country, \", \").concat(weather.name);\n      this.desc.textContent = weather.weather[0].description;\n      this.string = document.querySelector('#temp-btn').addEventListener('click', function () {\n        var x = document.getElementById('w-string');\n\n        if (x.innerHTML === \"\".concat(weather.main.temp, \"\\xB0C\")) {\n          x.innerText = weather.main.temp * 1.8 + 32;\n        } else {\n          x.innerHTML = \"\".concat(weather.main.temp, \"\\xB0C\");\n        }\n      });\n      this.icon.setAttribute('src', \"http://openweathermap.org/img/wn/\".concat(weather.weather[0].icon, \"@2x.png\"));\n      this.humidity.textContent = \"Humidity: \".concat(weather.main.humidity);\n      this.feelsLike.textContent = \"Feels Like: \".concat(weather.main.feels_like);\n      this.dewpoint.textContent = \"Visibility: \".concat(weather.visibility);\n      this.wind.textContent = \"Wind speed: \".concat(weather.wind.speed);\n    }\n  }]);\n\n  return UI;\n}();\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (UI);\n\n//# sourceURL=webpack://Weather-App/./src/components/ui.js?");
